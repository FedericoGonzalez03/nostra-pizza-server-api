...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-jut7oag.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-jut7oag.containers.anotherwebservice.com/
...
```
git clone git@github.com:FedericoGonzalez03/nostra-pizza-server-api.git
cd container-jut7oag
```
...
```
docker attach container-jut7oag
```
